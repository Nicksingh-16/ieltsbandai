...
<div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-surface-50">Edit Question</h1>
    ...
    <form method="POST" action="{{ route('institute.questions.update', $question) }}" class="card p-6 space-y-5">
        @csrf @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="md:col-span-2">
                <label class="block text-sm text-surface-400 mb-1">Title <span class="text-red-400">*</span></label>
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="active" class="text-sm text-surface-300">Active</label>
            </div>
        </div>
