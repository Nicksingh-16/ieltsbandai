...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-5">
            ...
            {{-- Mock test continuation (writing) — auto-advance, same pattern as listening/reading. --}}
            @if(session('mock_test_id'))
            <div class="card p-5 border border-brand-500/30 bg-brand-500/5 mb-3">
                <p class="font-semibold text-brand-400 text-sm mb-3">✅ Writing complete — continuing to Speaking in <span id="mockCountdown">4</span>s</p>
                <form id="mockAdvanceForm" method="POST" action="{{ route('mock-test.advance', ['mock' => session('mock_test_id'), 'module' => 'writing']) }}">
                    @csrf
